...
const Home = () => {
  return (
    <>
    <section class=" dark:bg-gray-900 mt-20" id="home">
    ...
    <section class=" dark:bg-gray-900 px-5 grid grid-cols-3 gap-4 place-items-center" id='features'>
...
>
  ...
  />
    ...
    <p className="m-0 p-3 line-clamp-3 text-yellow-500 text-2xl font-bold text-center bg-white">
